...
Ez a projekt egy LEMP stack (Linux, Nginx, MariaDB, PHP) alapú környezetet hoz létre docker-compose segítségével, terheléselosztással és Zabbix monitoringgal. A rendszer SSL/TLS titkosítást használ a biztonság érdekében, és tartalmaz két webszervert, amelyek a terhelést egy Nginx alapú load balancer segítségével osztják el.
...
Környezeti változók beállítása .env fájlban:

MARIADB_HOST=mariadb
MARIADB_DATABASE=lemp_app
MARIADB_USER=lemp_user
MARIADB_PASSWORD=erose_jelszo
DB_SERVER_HOST=mariadb
DB_SERVER_PORT=3306
DB_SERVER_DBNAME=zabbix
DB_SERVER_DBUSER=zabbix
DB_SERVER_DBPASSWORD=zabbix
DB_SERVER_ROOT_PASSWORD=root_erose_jelszo
...
Entrypoint script (entrypoint.sh) beállítja a Zabbix agent konfigurációját és indítja a szolgáltatásokat.
...
Minden konténer SSL támogatással fut, a MariaDB és Zabbix kommunikáció TLS-en keresztül történik.
